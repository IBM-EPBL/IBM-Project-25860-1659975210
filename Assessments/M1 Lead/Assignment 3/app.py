...
COS_API_KEY_ID="bawOZ5ho6R_77c3a3DeHTGbXsLq_x5BEC-kGdsrusv8h"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/61c1f8bad96141e3bd3f502676af7418:87c5d39b-ff67-4ee9-a3aa-9fcf75e68c6b::"
...
@app.route('/')
def index():
    files = get_bucket_contents('ibmm1')
